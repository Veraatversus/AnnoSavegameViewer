namespace AnnoSavegameViewer.Serialization.Core {
  ...
  /// <summary> Represents extension methods for <see cref="Endian"/> instances. </summary>
  public static class EndianExtensions {
    ...
    /// <returns> <see langword="true"/> if this is the system endianness; otherwise, <see langword="false"/>. </returns>
  ...
  /// <summary> Represents the possible byte order of binary data. </summary>
