...
namespace AnnoSavegameViewer.Structures.Savegame.Generated {
  ...
  public class CommandsList {
    ...
    public object InvokedByHuman { get; set; }

    [BinaryContent(Name = "InGroupOffset", NodeType = BinaryContentTypes.Attribute)]
    public object InGroupOffset { get; set; }

    [BinaryContent(Name = "StayInPlayableArea", NodeType = BinaryContentTypes.Attribute)]
    public object StayInPlayableArea { get; set; }

    [BinaryContent(Name = "InGroupOffset_TargetPosition", NodeType = BinaryContentTypes.Attribute)]
    public object InGroupOffset_TargetPosition { get; set; }
