...
namespace AnnoSerializer.Structures.Generated.a7s {
	...
	public partial class NoneSpawnDescription {
		...
		public SpawnDescriptionSpawnContextType SpawnContextType { get; set; }

		[BinaryContent(Name = "ParticipantIDClient", NodeType = BinaryContentTypes.Node)]
		public SpawnDescriptionParticipantIDClient ParticipantIDClient { get; set; }

		[BinaryContent(Name = "ParticipantIDPlayer", NodeType = BinaryContentTypes.Node)]
		public SpawnDescriptionParticipantIDPlayer ParticipantIDPlayer { get; set; }
