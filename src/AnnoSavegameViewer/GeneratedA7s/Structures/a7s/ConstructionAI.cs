...
namespace AnnoSerializer.Structures.Generated.a7s {
	...
	public partial class ConstructionAI {
		...
		public ConstructionAIConstructionQueue ConstructionQueue { get; set; }
		...
		public HexString NextCityBlockID { get; set; }

		[BinaryContent(Name = "NextProductionBlockID", NodeType = BinaryContentTypes.Attribute)]
		public HexString NextProductionBlockID { get; set; }
		...
		public HexString AITIme { get; set; }
		...
		public HexString MainIsland { get; set; }

		[BinaryContent(Name = "NextCulturalBlockID", NodeType = BinaryContentTypes.Attribute)]
		public HexString NextCulturalBlockID { get; set; }
