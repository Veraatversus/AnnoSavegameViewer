...
namespace AnnoSavegameViewer.Serialization.Memory {
  ...
  public ref struct SpanReader2 {
    ...
    public SpanReader(Memory<byte> memory, Endian endian = Endian.System, Encoding encoding = null)
      : this(memory.Span, endian, encoding) {
      Memory = memory;
    }
    ...
    public Byte[] ReadBytes(int count) {
      var value = Span.Slice(Position, count).ToArray();
            Position += count;
      return value;
    }
