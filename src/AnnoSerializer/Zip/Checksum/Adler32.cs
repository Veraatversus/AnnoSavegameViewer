...
namespace CSharpCode.SharpZipLib.Checksum {
  using System;
  ...
  ///    checksum of zero.)"
  /// </summary>
  /// <see cref="CSharpCode.SharpZipLib.Zip.Compression.Streams.InflaterInputStream"/>
  /// <see cref="CSharpCode.SharpZipLib.Zip.Compression.Streams.DeflaterOutputStream"/>
