...
namespace CSharpCode.SharpZipLib.Zip.Compression {
  using CSharpCode.SharpZipLib.Checksum;
  using System;
...
*/
    ...
    private int InsertString() {
      short match;
      var hash = ((ins_h << DeflaterConstants.HASH_SHIFT) ^ window[strstart + (DeflaterConstants.MIN_MATCH - 1)]) & DeflaterConstants.HASH_MASK;
